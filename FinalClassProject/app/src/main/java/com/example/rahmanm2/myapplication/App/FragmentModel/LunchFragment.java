...
import com.example.rahmanm2.myapplication.Adapter.launchAdapter;
...
public class LunchFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView)view.findViewById(R.id.launchRecyclerID);
    ...
    private List<HorizontalViewIngredians> getLaunch(){
        final List<HorizontalViewIngredians>listItems = new ArrayList<>();
        mDatabaseReference.orderByChild("recipeCatagory").equalTo("Lunch").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Adapter = new launchAdapter(getContext(),listItems);
