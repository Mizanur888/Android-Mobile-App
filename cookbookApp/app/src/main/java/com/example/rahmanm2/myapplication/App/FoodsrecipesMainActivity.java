  ...
  //  android:drawable="@color/button_pressed"/>
    ...
    private void voiceSearch(){
        ...
        if(LoginActivity.IsLogedin == false){
            //CoordinatorLayout.LayoutParams p = (CoordinatorLayout.LayoutParams) voiceSearch.getLayoutParams();
            //p.setAnchorId(View.NO_ID);
            //voiceSearch.setLayoutParams(p);
            voiceSearch.setVisibility(View.GONE);
        }
        else if(LoginActivity.IsLogedin ==true) {
